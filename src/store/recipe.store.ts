...
export const useRecipeStore = create<IRecipeState>((set) => ({
  ...
  addRecipe: async (formData: FormData) => {
    ...
    try {
      ...
      console.error("error", error);
      set({ error: "Помилка додавання даних", isLoading: false });
      return { success: false, error: "Помилка додавання даних" };
    }
  },
  updateRecipe: async (id: string, formData: FormData) => {
    ...
    try {
      ...
      console.error("error", error);
      set({ error: "Помилка оновлення даних", isLoading: false });
  ...
  removeRecipe: async (id: string) => {
    ...
    try {
      ...
      console.error("error", error);
      set({ error: "Помилка видалення даних", isLoading: false });
    }
  },
}));
