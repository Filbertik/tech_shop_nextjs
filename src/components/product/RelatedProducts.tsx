      ...
      <div className="grid grid-cols-2 gap-x-[40px] gap-y-[20px]">
        {products.map((product) => (
          <div
            ...
            className="
              w-[300px] h-[217px] 
              border rounded p-[20px] bg-white 
              flex flex-col justify-between
              transition-all duration-300
              hover:shadow-lg hover:border-[#355EC0] hover:-translate-y-[4px]
              group
            "
          >
            {/* TOP BLOCK */}
            <div className="w-[260px] h-[125px] flex items-start">
              <Image
                src={product.image}
                alt={product.name}
                width={124}
              ...
              <p className="ml-[12px] text-[16px] leading-[150%] text-black">
                {product.name}
              </p>
            </div>
            ...
            <div className="w-[260px] h-[40px] flex items-center justify-between mt-[12px]">
              ...
              <button
                className="
                  bg-[#355EC0] rounded-[4px] w-[64px] h-[40px]
                  flex items-center justify-center
                  transition-all duration-300
                  hover:bg-[#2a4aa0] active:scale-95
                "
              >
                <Image
