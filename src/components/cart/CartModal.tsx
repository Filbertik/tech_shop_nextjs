...
export default function CartModal() {
  ...
  return (
    // 🔥 BACKDROP (клік → закриття)
    <div
      onClick={closeCart}
      className="fixed top-0 right-0 w-full h-full bg-black/30 flex justify-end z-50"
    >
      {/* 🔥 STOP PROPAGATION (щоб не закривалось при кліку всередині) */}
      <div
        onClick={(e) => e.stopPropagation()}
        className="w-[590px] bg-white p-[40px] rounded-l-[4px] flex flex-col"
      >
        {/* HEADER */}
