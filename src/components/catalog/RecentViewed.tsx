...
export default function RecentViewed() {
  ...
  const scroll = (direction: "left" | "right") => {
    ...
    const scrollAmount = 320; // ширина прокрутки (1–2 картки)
      ...
      <div className="relative mt-[28px]">
        ...
        <button
          ...
          className="
            ...
            bg-white shadow-md border rounded-full
            w-[40px] h-[40px]
        ...
        >
          {loading
            ? Array.from({ length: 4 }).map((_, i) => (
                <div
                  key={i}
                  className="min-w-[280px] border p-[12px] rounded animate-pulse h-[320px]"
                />
              ))
...
// import ProductCard from "@/components/ProductCard"; // 👈 підкоригуй шлях якщо треба
// import type { Product } from "@/types/product";
...
//               <div
//                 key={i}
//                 className="border p-[12px] rounded animate-pulse h-[320px]"
//               />
//             ))
//           : products.map((product) => (
